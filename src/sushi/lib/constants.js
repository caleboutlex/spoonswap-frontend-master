...
12 SPOON 0xce84867c3c02b05dc570d0135103d3fb9cc19433
*/
...
export const contractAddresses = {
  sushi: {
    42: '0xDCAFBF57105468a7785CBdeB82F01Cc677d01623', // spoon ! 
    1:  '0x6b3595068778dd592e39a122f4f5a5cf09c90fe2', // real sushi mainnet still need to deploy 
  },
  masterChef: {
    42: '0xE403a3aa44e5C6eB056886025ff1c2bFF6a4096f',
    1:  '0xc2edad668740f1aa35e4d8f227fb8e17dca888cd', // real masterchef mainnet still need to deploy 
  },
  weth: {
    42: '0xd0A1E359811322d97991E03f863a0C30C2cF029C',
    1:  '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2', // real WETH mainnet
  },
  xSushi: {
    42: '0x8798249c2e607446efb7ad49ec89dd1865ff4272', // NOTE: Not in use
    1:  '0x8798249c2e607446efb7ad49ec89dd1865ff4272', // real sushi mainnet still need to deploy 
  },
  defiwizard: {
    42: '0x008f7bB5F6e0e18774df3c1348550646c4C11B2a',
    1: '0x8798249c2e607446efb7ad49ec89dd1865ff4272', // NON EXISTENT ATM still need to deploy 
  },
}
...
export const supportedPools = [
  {
    pid: 1,
    lpAddresses: {
      42: '0x8ae5989196f63ba2ec414632a9975b55762a0db5', // LP Token Address
    },
    tokenAddresses: {
      42: '0xdcafbf57105468a7785cbdeb82f01cc677d01623', // Token, i.e. "SPOON"
    },
    name: 'Defi Fuckery!',
    symbol: 'SPOON-ETH LP',
    tokenSymbol: 'SPOON',
  ...
  },
  {
    pid: 0,
    lpAddresses: {
      42: '0x7480A446b5fc8E7a3A57E18D26a50D3f771c907b', // LP Token Address
      1: '0x06da0fd433C1A5d7a4faa01111c044910A184553',
    },
    tokenAddresses: {
      42: '0x41B5844f4680a8C38fBb695b7F9CFd1F64474a72', // Token, i.e. "cETH"
  ...
  },
  {
    pid: 2,
    lpAddresses: {
      42: '0x2e0f7e2f3b69fec69c06ce5b7f1c64a380cb5312', // LP Token Address
    },
    tokenAddresses: {
      42: '0xdcafbf57105468a7785cbdeb82f01cc677d01623', // Token, i.e. "SPOON"
    },
    name: 'Balance Spoons!',
    symbol: 'SPOON-ETH BLP',
    tokenSymbol: 'SPOON',
    icon: ' ⚖️ ',
  },
]
