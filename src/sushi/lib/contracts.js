...
import DEFIWIZARDAbi from './abi/defiwizard.json'
import {
  contractAddresses,
  SUBTRACT_GAS_LIMIT,
  supportedPools,
...
export class Contracts {
  constructor(provider, networkId, web3, options) {
    ...
    this.defiwizard = new this.web3.eth.Contract(DEFIWIZARDAbi)
  ...
  setProvider(provider, networkId) {
    ...
    setProvider(this.defiwizard, contractAddresses.defiwizard[networkId])
  ...
  setDefaultAccount(account) {
    ...
    this.defiwizard.options.from = account
  }
